                    ...
                    <div className='row' style={{ display: 'flex' }}>
                        ...
                        <div className='col-md-5'>
                            ...
                            <p className="mt-4">
                                ...
                                using 3D technology. It all starts with imagination, which then turns into ideas.
                                ...
                                each client’s vision and helping them overcome their challenges. Designer Anntje has
